    ...
    <>
      ...
      <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center py-8 px-4">
        <h1 className="text-2xl font-bold mb-6 uppercase">
          CREATE A {type.charAt(0).toUpperCase() + type.slice(1)}
        </h1>
        ...
        <div className="flex gap-4 mb-6">
          {["post", "reel"].map((t) => (
            <button
              key={t}
              className={`px-4 py-2 rounded-full transition-colors ${type === t ? "bg-blue-500" : "bg-gray-700 hover:bg-gray-600"
                }`}
              onClick={() => setType(t)}
            >
        ...
        <div className="w-full max-w-2xl flex flex-col items-center bg-gray-800 p-6 rounded-2xl shadow-lg">
          ...
          <button
            ...
            className={`mt-5 w-full py-2 rounded-md font-semibold transition-colors flex items-center justify-center gap-2 ${loading || (showTrimmer && getTrimmedDuration() > MAX_VIDEO_DURATION_SEC)
